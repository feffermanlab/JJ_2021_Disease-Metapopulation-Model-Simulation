...
% Matlab code to generate Figure 3 & 4 for manuscript titled "The Eco-Epidemiological Dynamics of Evolutionary Rescue in a Host Metapopulation"
...
% dlmwrite('SIRmodel_WT_cycles_avepop_aveInfect_Trans_vs_Growth.csv',XXW,'-append');
% 
% XXR = [i,jj,cyclesR1,cyclesR2,cyclesR3,cyclesR4,ave_popR1,ave_popR2,ave_popR3,ave_popR4,I_R1,I_R2,I_R3,I_R4];
% dlmwrite('SIRmodel_RT_cycles_avepop_aveInfect_Trans_vs_Growth.csv',XXR,'-append');
...
filename = sprintf('Trans_Ratio %d vs Growth_Ratio %d.png',i,jj);
